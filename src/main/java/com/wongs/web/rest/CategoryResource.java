...
/**
 * REST controller for managing {@link com.wongs.domain.Category}.
 */
@RestController
@RequestMapping("/api")
public class CategoryResource {
    ...
    public ResponseEntity<List<CategoryDTO>> getAllCategories(Pageable pageable, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
