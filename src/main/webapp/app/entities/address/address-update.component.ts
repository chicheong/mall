...
export class AddressUpdateComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.stateService
            .query()
            .pipe(
                filter((mayBeOk: HttpResponse<IState[]>) => mayBeOk.ok),
                map((response: HttpResponse<IState[]>) => response.body)
            )
            .subscribe((res: IState[]) => (this.states = res), (res: HttpErrorResponse) => this.onError(res.message));
    }
