...
export class OrderShopComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.orderShopService
                ...
                .subscribe(
                    (res: HttpResponse<IOrderShop[]>) => this.paginateOrderShops(res.body, res.headers),
    ...
    trackId(index: number, item: IOrderShop) {
        return item.id;
    }
    ...
    protected paginateOrderShops(data: IOrderShop[], headers: HttpHeaders) {
