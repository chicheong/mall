...
export class ProductItemHistoryService {
    ...
    private resourceUrl = 'api/product-item-histories';
    private resourceSearchUrl = 'api/_search/product-item-histories';

    constructor(private http: Http, private dateUtils: JhiDateUtils) { }

    create(productItemHistory: ProductItemHistory): Observable<ProductItemHistory> {
    ...
    update(productItemHistory: ProductItemHistory): Observable<ProductItemHistory> {
        const copy = this.convert(productItemHistory);
    ...
    find(id: number): Observable<ProductItemHistory> {
