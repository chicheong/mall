...
export class ShippingTypeComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.shippingTypeService
                ...
                .subscribe(
                    (res: HttpResponse<IShippingType[]>) => this.paginateShippingTypes(res.body, res.headers),
    ...
    trackId(index: number, item: IShippingType) {
        return item.id;
    }
    ...
    protected paginateShippingTypes(data: IShippingType[], headers: HttpHeaders) {
