...
export class QuantityComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    if (this.currentSearch) {
      this.quantityService
        ...
        .subscribe(
          (res: HttpResponse<IQuantity[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
          () => this.onError()
        );
      return;
    }
  ...
  trackId(index: number, item: IQuantity): number {
    // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
    return item.id!;
  }

  registerChangeInQuantities(): void {
    this.eventSubscriber = this.eventManager.subscribe('quantityListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IQuantity[] | null, headers: HttpHeaders, page: number): void {
