...
export class QuantityComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.quantityService
                ...
                .subscribe(
                    (res: HttpResponse<IQuantity[]>) => this.paginateQuantities(res.body, res.headers),
    ...
    trackId(index: number, item: IQuantity) {
        return item.id;
    }
    ...
    protected paginateQuantities(data: IQuantity[], headers: HttpHeaders) {
