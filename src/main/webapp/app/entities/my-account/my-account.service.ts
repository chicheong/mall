...
export class MyAccountService {
    ...
    create(myAccount: MyAccount): Observable<MyAccount> {
    ...
    update(myAccount: MyAccount): Observable<MyAccount> {
        const copy = this.convert(myAccount);
    ...
    find(id: number): Observable<MyAccount> {
     ...
     */
    private convertItemFromServer(json: any): MyAccount {
        const entity: MyAccount = Object.assign(new MyAccount(), json);
        return entity;
    }
