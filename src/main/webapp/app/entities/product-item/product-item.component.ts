...
export class ProductItemComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    if (this.currentSearch) {
      this.productItemService
        ...
        .subscribe(
          (res: HttpResponse<IProductItem[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInProductItems(): void {
    this.eventSubscriber = this.eventManager.subscribe('productItemListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IProductItem[] | null, headers: HttpHeaders, page: number): void {
