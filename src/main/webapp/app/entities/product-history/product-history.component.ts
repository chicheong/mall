...
export class ProductHistoryComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.productHistoryService
                ...
                .subscribe(
                    (res: HttpResponse<IProductHistory[]>) => this.paginateProductHistories(res.body, res.headers),
    ...
    trackId(index: number, item: IProductHistory) {
        return item.id;
    }
    ...
    protected paginateProductHistories(data: IProductHistory[], headers: HttpHeaders) {
