...
export class ShippingComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    if (this.currentSearch) {
      this.shippingService
        ...
        .subscribe(
          (res: HttpResponse<IShipping[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInShippings(): void {
    this.eventSubscriber = this.eventManager.subscribe('shippingListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IShipping[] | null, headers: HttpHeaders, page: number): void {
