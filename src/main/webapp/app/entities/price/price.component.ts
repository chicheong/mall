...
export class PriceComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    if (this.currentSearch) {
      this.priceService
        ...
        .subscribe(
          (res: HttpResponse<IPrice[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInPrices(): void {
    this.eventSubscriber = this.eventManager.subscribe('priceListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IPrice[] | null, headers: HttpHeaders, page: number): void {
