...
export class DelegationComponent implements OnInit, OnDestroy {
  ...
  loadAll(): void {
    if (this.currentSearch) {
      this.delegationService
        ...
        .subscribe((res: HttpResponse<IDelegation[]>) => this.paginateDelegations(res.body, res.headers));
      return;
    }
  ...
  registerChangeInDelegations(): void {
    this.eventSubscriber = this.eventManager.subscribe('delegationListModification', () => this.reset());
  }
  ...
  protected paginateDelegations(data: IDelegation[] | null, headers: HttpHeaders): void {
