...
/**
 * Performance test for the Shipping entity.
 */
class ShippingGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Shipping entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created shipping")
                .get("${new_shipping_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created shipping")
            .delete("${new_shipping_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
