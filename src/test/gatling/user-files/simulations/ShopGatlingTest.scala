...
class ShopGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Shop entity")
        ...
        .repeat(2) {
            ...
            .post("/api/shops")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "code":"SAMPLE_TEXT", "name":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "status":null, "createdBy":"SAMPLE_TEXT", "createdDate":"2020-01-01T00:00:00.000Z", "lastModifiedBy":"SAMPLE_TEXT", "lastModifiedDate":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
