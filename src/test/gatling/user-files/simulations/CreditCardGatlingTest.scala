...
/**
 * Performance test for the CreditCard entity.
 */
class CreditCardGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the CreditCard entity")
