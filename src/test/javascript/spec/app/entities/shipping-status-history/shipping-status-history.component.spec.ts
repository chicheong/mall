...
import { ShippingStatusHistoryComponent } from 'app/entities/shipping-status-history/shipping-status-history.component';
...
describe('Component Tests', () => {
  describe('ShippingStatusHistory Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.shippingStatusHistories && comp.shippingStatusHistories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
