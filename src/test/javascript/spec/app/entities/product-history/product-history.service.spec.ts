...
describe('Service Tests', () => {
    ...
    describe('ProductHistory Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ProductHistoryService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/product-histories/' + 123);
            });
            it('should return ProductHistory', () => {

                let entity: ProductHistory;
                service.find(123).subscribe((_entity: ProductHistory) => {
                    entity = _entity;
                });
