...
import { ProductHistoryComponent } from 'app/entities/product-history/product-history.component';
...
describe('Component Tests', () => {
  describe('ProductHistory Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.productHistories && comp.productHistories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
