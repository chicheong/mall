...
describe('Service Tests', () => {
    describe('MyState Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a MyState', async () => {
            ...
            it('should update a MyState', async () => {
                const returnedFromService = Object.assign(
                    {
                        code: 'BBBBBB',
                        label: 'BBBBBB',
            ...
            it('should return a list of MyState', async () => {
                const returnedFromService = Object.assign(
                    {
                        code: 'BBBBBB',
                        label: 'BBBBBB',
            ...
            it('should delete a MyState', async () => {
