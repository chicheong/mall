...
describe('Service Tests', () => {
    ...
    describe('ProductItemHistory Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ProductItemHistoryService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/product-item-histories/' + 123);
            });
            it('should return ProductItemHistory', () => {

                let entity: ProductItemHistory;
                service.find(123).subscribe((_entity: ProductItemHistory) => {
                    entity = _entity;
                });
