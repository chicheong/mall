...
describe('Service Tests', () => {
    describe('ProductItemHistory Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a ProductItemHistory', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        createdDate: currentDate.format(DATE_TIME_FORMAT)
                ...
                service
                    .create(new ProductItemHistory(null))
                    .pipe(take(1))
            ...
            it('should update a ProductItemHistory', async () => {
                const returnedFromService = Object.assign(
                    {
                        code: 'BBBBBB',
                        isDefault: true,
            ...
            it('should return a list of ProductItemHistory', async () => {
                const returnedFromService = Object.assign(
                    {
                        code: 'BBBBBB',
                        isDefault: true,
            ...
            it('should delete a ProductItemHistory', async () => {
