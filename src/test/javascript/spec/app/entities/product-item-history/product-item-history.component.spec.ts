...
import { ProductItemHistoryComponent } from 'app/entities/product-item-history/product-item-history.component';
...
describe('Component Tests', () => {
  describe('ProductItemHistory Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.productItemHistories && comp.productItemHistories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
