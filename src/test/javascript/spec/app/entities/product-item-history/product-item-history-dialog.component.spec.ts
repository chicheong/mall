...
describe('Component Tests', () => {
    ...
    describe('ProductItemHistory Management Dialog Component', () => {
        let comp: ProductItemHistoryDialogComponent;
        let fixture: ComponentFixture<ProductItemHistoryDialogComponent>;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(ProductItemHistoryDialogComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(ProductItemHistoryDialogComponent);
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        comp.productItemHistory = entity;
                        // WHEN
                        comp.save();
                        tick(); // simulate async
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'productItemHistoryListModification', content: 'OK'});
