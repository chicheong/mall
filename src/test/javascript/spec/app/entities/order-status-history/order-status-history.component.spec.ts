...
import { OrderStatusHistoryComponent } from 'app/entities/order-status-history/order-status-history.component';
...
describe('Component Tests', () => {
  describe('OrderStatusHistory Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.orderStatusHistories && comp.orderStatusHistories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
