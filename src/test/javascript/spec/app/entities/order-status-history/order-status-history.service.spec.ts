...
describe('Service Tests', () => {
    ...
    describe('OrderStatusHistory Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(OrderStatusHistoryService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/order-status-histories/' + 123);
            });
            it('should return OrderStatusHistory', () => {

                let entity: OrderStatusHistory;
                service.find(123).subscribe((_entity: OrderStatusHistory) => {
                    entity = _entity;
                });
