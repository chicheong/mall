...
describe('Service Tests', () => {
    describe('CurrencyRate Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a CurrencyRate', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        from: currentDate.format(DATE_TIME_FORMAT),
            ...
            it('should update a CurrencyRate', async () => {
                const returnedFromService = Object.assign(
                    {
                        from: currentDate.format(DATE_TIME_FORMAT),
                        to: currentDate.format(DATE_TIME_FORMAT),
            ...
            it('should return a list of CurrencyRate', async () => {
                const returnedFromService = Object.assign(
                    {
                        from: currentDate.format(DATE_TIME_FORMAT),
                        to: currentDate.format(DATE_TIME_FORMAT),
            ...
            it('should delete a CurrencyRate', async () => {
