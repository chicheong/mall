...
describe('Service Tests', () => {
    ...
    describe('CurrencyRate Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(CurrencyRateService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/currency-rates/' + 123);
            });
            it('should return CurrencyRate', () => {

                let entity: CurrencyRate;
                service.find(123).subscribe((_entity: CurrencyRate) => {
                    entity = _entity;
                });
