...
import { ShippingTypeComponent } from 'app/entities/shipping-type/shipping-type.component';
...
describe('Component Tests', () => {
  describe('ShippingType Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.shippingTypes && comp.shippingTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
