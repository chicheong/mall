...
describe('Service Tests', () => {
    ...
    describe('ProductStyle Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ProductStyleService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/product-styles/' + 123);
            });
            it('should return ProductStyle', () => {

                let entity: ProductStyle;
                service.find(123).subscribe((_entity: ProductStyle) => {
                    entity = _entity;
                });
