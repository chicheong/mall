...
describe('Service Tests', () => {
    describe('ProductStyle Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a ProductStyle', async () => {
            ...
            it('should update a ProductStyle', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        code: 'BBBBBB',
            ...
            it('should return a list of ProductStyle', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        code: 'BBBBBB',
            ...
            it('should delete a ProductStyle', async () => {
