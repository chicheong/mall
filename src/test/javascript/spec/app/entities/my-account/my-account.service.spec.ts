...
describe('Service Tests', () => {
    ...
    describe('MyAccount Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(MyAccountService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/my-accounts/' + 123);
            });
            it('should return MyAccount', () => {

                let entity: MyAccount;
                service.find(123).subscribe((_entity: MyAccount) => {
                    entity = _entity;
                });
