...
describe('Service Tests', () => {
    ...
    describe('MyOrder Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(MyOrderService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/my-orders/' + 123);
            });
            it('should return MyOrder', () => {

                let entity: MyOrder;
                service.find(123).subscribe((_entity: MyOrder) => {
                    entity = _entity;
                });
