...
describe('Service Tests', () => {
    ...
    describe('OrderItem Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(OrderItemService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/order-items/' + 123);
            });
            it('should return OrderItem', () => {

                let entity: OrderItem;
                service.find(123).subscribe((_entity: OrderItem) => {
                    entity = _entity;
                });
