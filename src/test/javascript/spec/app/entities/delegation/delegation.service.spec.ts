...
describe('Service Tests', () => {
    ...
    describe('Delegation Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(DelegationService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/delegations/' + 123);
            });
            it('should return Delegation', () => {

                let entity: Delegation;
                service.find(123).subscribe((_entity: Delegation) => {
                    entity = _entity;
                });
