...
import { IDelegation, Delegation, DelegationType, CommonStatus } from 'app/shared/model/delegation.model';
...
describe('Service Tests', () => {
    describe('Delegation Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should return a list of Delegation', async () => {
                const returnedFromService = Object.assign(
                    {
                        from: currentDate.format(DATE_TIME_FORMAT),
                        to: currentDate.format(DATE_TIME_FORMAT),
