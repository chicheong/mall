...
describe('Service Tests', () => {
    ...
    describe('ProductItem Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ProductItemService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/product-items/' + 123);
            });
            it('should return ProductItem', () => {

                let entity: ProductItem;
                service.find(123).subscribe((_entity: ProductItem) => {
                    entity = _entity;
                });
