...
describe('Service Tests', () => {
    ...
    describe('ProductStyleHistory Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ProductStyleHistoryService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/product-style-histories/' + 123);
            });
            it('should return ProductStyleHistory', () => {

                let entity: ProductStyleHistory;
                service.find(123).subscribe((_entity: ProductStyleHistory) => {
                    entity = _entity;
                });
