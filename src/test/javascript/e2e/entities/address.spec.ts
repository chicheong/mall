...
describe('Address e2e test', () => {
    ...
    it('should load Addresses', () => {
        ...
        expect(addressComponentsPage.getTitle()).toMatch(/mallApp.address.home.title/);
    ...
    it('should load create Address dialog', () => {
        ...
        expect(addressDialogPage.getModalTitle()).toMatch(/mallApp.address.home.createOrEditLabel/);
