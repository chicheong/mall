...
describe('Department e2e test', () => {
    ...
    it('should load Departments', async () => {
        ...
        expect(await departmentComponentsPage.getTitle()).to.eq('mallApp.department.home.title');
    });
    ...
    it('should load create Department page', async () => {
        ...
        expect(await departmentUpdatePage.getPageTitle()).to.eq('mallApp.department.home.createOrEditLabel');
    ...
    it('should create and save Departments', async () => {
        ...
        await promise.all([
            ...
            departmentUpdatePage.statusSelectLastOption(),
            departmentUpdatePage.parentSelectLastOption()
            // departmentUpdatePage.officeSelectLastOption(),
        ]);
        expect(await departmentUpdatePage.getCodeInput()).to.eq('code');
        expect(await departmentUpdatePage.getNameInput()).to.eq('name');
    ...
    it('should delete last Department', async () => {
        ...
        expect(await departmentDeleteDialog.getDialogTitle()).to.eq('mallApp.department.delete.question');
