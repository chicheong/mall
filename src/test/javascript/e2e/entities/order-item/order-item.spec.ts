...
describe('OrderItem e2e test', () => {
    ...
    it('should load OrderItems', async () => {
        ...
        expect(await orderItemComponentsPage.getTitle()).to.eq('mallApp.orderItem.home.title');
    });
    ...
    it('should load create OrderItem page', async () => {
        ...
        expect(await orderItemUpdatePage.getPageTitle()).to.eq('mallApp.orderItem.home.createOrEditLabel');
    ...
    it('should create and save OrderItems', async () => {
        ...
        await promise.all([
            ...
            orderItemUpdatePage.currencySelectLastOption(),
            orderItemUpdatePage.shopSelectLastOption()
        ]);
        expect(await orderItemUpdatePage.getQuantityInput()).to.eq('5');
        expect(await orderItemUpdatePage.getPriceInput()).to.eq('5');
    ...
    it('should delete last OrderItem', async () => {
        ...
        expect(await orderItemDeleteDialog.getDialogTitle()).to.eq('mallApp.orderItem.delete.question');
