...
describe('MyAccount e2e test', () => {
    ...
    it('should load MyAccounts', () => {
        ...
        expect(myAccountComponentsPage.getTitle()).toMatch(/mallApp.myAccount.home.title/);
    ...
    it('should load create MyAccount dialog', () => {
        ...
        expect(myAccountDialogPage.getModalTitle()).toMatch(/mallApp.myAccount.home.createOrEditLabel/);
